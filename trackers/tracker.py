...
class Tracker:
    ...
    def get_object_trackes(self,frames,read_from_stub=False,stub_path=None):
        ...
        for frame_num, detection in enumerate(detections):
            ...
            for frame_detection in detection_with_tracks:
                ...
                if cls_names[cls_id] == cls_names_inv["player"]:
                    tracks["players"][frame_num][track_id] = {"bbox":bbox}
                    
                if cls_names[cls_id] == cls_names_inv["referee"]:
            ...
            for frame_detection in detection_with_tracks:
                ...
                if cls_names[cls_id] == cls_names_inv["ball"]:
    ...
    def draw_annotations(self,video_frames,tracks):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            output_frames_frames.append(frame)
        return output_frames_frames